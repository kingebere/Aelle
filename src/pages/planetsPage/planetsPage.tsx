...
function PlanetsPage() {
  ...
  >([]);
  const [names] = useState<string>("planets");
  ...
  const fetchData = (pages: number) =>
    axios.get(`https://swapi.dev/api/planets/?page=${pages}`);
  ...
  // diffcult to route properly. I decided to extract the id
  // from the url value, which contains a suitable option to use as id
  ...
  // function for incrementing to the next page ,
  // it also increments the page indicator .It also sets the state of the filter
  ...
  return (
    <div className="page">
      <div className="page__1">
        <h1 className="page__1__text">Planets</h1>
        <div>
