...
const FilmsPage: React.FC<{}> = () => {
  ...
  const fetchData = (page: number) => {
    return axios.get(`https://swapi.dev/api/films/?page=${page}`);
  };
  ...
  // function for decrementing to the next page ,it also decrements the page indicator .It also sets the state of the filter
